...
export function Partnerships() {
  const industries = [
    ...
    },
    {
      ...
      tag: "Elite Travel",
      image: "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=600&h=400&fit=crop&q=80"
    },
    {
      title: "Retail & E-Commerce",
      tag: "Scale Ready",
      image: "https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=600&h=400&fit=crop&q=80"
    },
    {
    ...
    },
    {
      title: "NRI Special",
      tag: "Global Indian",
      image: "https://images.unsplash.com/photo-1569025591185-197a07962c84?w=600&h=400&fit=crop&q=80"
    },
    {
      title: "Banking DSA",
      tag: "Finance Elite",
      image: "https://images.unsplash.com/photo-1541354329998-f4d9a9f9297a?w=600&h=400&fit=crop&q=80"
    },
    {
    ...
    },
    {
      ...
      tag: "Early Access",
      image: "https://images.unsplash.com/photo-1559136555-9303baea8eae?w=600&h=400&fit=crop&q=80"
    }
  ];
          ...
          {industries.map((card, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4">
                <p className="text-white font-bold text-[14px] md:text-[15px] leading-tight mb-1">
                  {card.title}
                </p>
                <span className="inline-block bg-[#F5A623] text-black text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wide">
                  {card.tag}
                </span>
              </div>
            </motion.div>
